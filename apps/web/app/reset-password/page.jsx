...
import PasswordUpdateForm from '../password-update-form.jsx';

export const metadata = {
  title: 'Set new password — NusaNexus Router'
};
    ...
    <main style={{ minHeight: '100vh', background: '#f8fafc', color: '#111827', fontFamily: 'sans-serif' }}>
      <div style={{ maxWidth: 420, margin: '0 auto', padding: '48px 24px', display: 'grid', gap: 20 }}>
        <header style={{ display: 'grid', gap: 8 }}>
          ...
          <p style={{ margin: 0, color: '#4b5563' }}>Choose a new password for your account.</p>
        </header>
